...
const ImagesGalleryCarousel = props => {
    return (
        ...
        <div class="carousel-indicators">          
            ...
            <button type="button" data-bs-target={`#${props.dataImages[0].carouselId}`} data-bs-slide-to="3" aria-label="Slide 4"></button>
            <button type="button" data-bs-target={`#${props.dataImages[0].carouselId}`} data-bs-slide-to="4" aria-label="Slide 5"></button>
            <button type="button" data-bs-target={`#${props.dataImages[0].carouselId}`} data-bs-slide-to="5" aria-label="Slide 6"></button>
        </div>
            ...
            {props.dataImages.map(image => {
                return(
                    <div class={`carousel-item  + ${image.active}`}>
                        <img className='carousel-img' src={image.imgSrc} class="d-block w-100" alt={image.title}/>
                    </div>  
                )              
            })}
        </div>
