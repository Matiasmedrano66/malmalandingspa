...
const Contact = () => {
    ...
    return (
        <div className="contact row fade-top" name="contact" id="social-media">
            <h1 className='social-contact-header'>Social Networks</h1>
            <div className="social-container col-lg-3 col-xs-12">
            ...
            <div className="social-container col-lg-3 col-xs-12">
                ...
                <h6 className="social-media-title">EMAIL</h6>
                <a className="social-media-link" href="mailto:informacion@alma.com.ar">information@malma.com.ar</a> 
            </div>
            <div className="social-container col-lg-3 col-xs-12">
                ...
                <h6 className="social-media-title">INSTAGRAM</h6>
                <a className="social-media-link" href="https://www.instagram.com/alto_palermo/?hl=es-la" target="_blank">@malmadesigns</a> 
